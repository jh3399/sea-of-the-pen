...
// 위에서 내려다본 돛 — 활 모양 단면(캠버)을 가진 흰 초승달. 옆에서 본 삼각돛(돛대·붐)이
// 아니라 위에서 본 돛의 두께다: 활대를 잇는 선(가로, 좌우 두 점에서 만난다)과 바람을 받아
// 부푼 볼록면(아래) 사이에 얇은 초승달 모양의 틈이 진다.
// ★ 다른 방향성 그리드(부스터·노)와 같은 규약 — 그리드 기준 방향(+Y, 아래)이 곧 돛의
//   법선(`item.angle`, 바람을 미는 방향)이다(`markerAngleToward` 가 이 축을 돌린다).
//   그래서 볼록한 배(캠버)를 위가 아니라 **아래**(+Y)에 둔다. 순풍을 받아 부풀 때의 모양
//   (`sail/render.js#drawSail`)과 같은 활 두 개로 만들어 정지 아이콘과 항해 중 렌더가
//   같은 실루엣 문법을 쓴다.
const SAIL_GRID = [
  '..C..........................................C..',
  '...CCC....................................CCC...',
