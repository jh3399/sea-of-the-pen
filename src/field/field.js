...
export const SCALAR_FIELDS = ['temperature', 'moisture', 'electric', 'magnetic'];
 ...
 *   벡터장 소스는 `{shape, ..., x, y}` 의 x·y 가 **벡터 성분**이고,
 *   스칼라장 소스는 `{shape, ..., value}` 다.
 * @returns {{sampleVector(name,x,y), sampleScalar(name,x,y), def, isEmpty}}
 */
