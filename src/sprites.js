...
export const SPRITES = {
  ...
  ru: {
    ...
    rows: [
      ...
      '.kffppk..........kppffk.',
      '.kfffpk..........kpfffk.',
      '.klffffkkkkkkkkkkffffdk.',
      '.klffffffffffffffffffdk.',
      '.klffsssffffffffsssffdk.',
      '.klfffsffffffffffsfffdk.',
      '.klffffffffffffffffffdk.',
      '.klffffffffffffffffffdk.',
      ...
      '.klfffkkkkffffffkkkkfdk.',
      '.klffffffffffffffffffdk.',
      '.klffffffwwppwwffffffdk.',
      '.klfffffwwwkkwwwfffffdk.',
      '.kdfffffwwkwwkwwfffffdk.',
      '.kdffffffwwwwwwffffffdk.',
      '..kdfffffwwwwwwfffffdk..',
      '...kdffffwwwwwwffffdk...',
      '....kdfffwwwwwwfffdk....',
      '.....krrrrrrrrrrrrk.....',
      '....krrrrrrrrrrrrrrk....',
      '..kqqrrrrrrrrrrrrrrqqk..',
      '.kvvvvqqrrrrrrrrqqvvvvk.',
      '.kvvuvvvffffffffvvvuvvk.',
      '.kvvuvvvfflffllfvvvuvvk.',
      '.kvvuvvvvffffffvvvvuvvk.',
  ...
  // 가르 — 황금 재규어 (1섬 보스). 네일의 검은 잉크에 물들어 폭주 중 —
