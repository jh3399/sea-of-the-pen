...
export const ISLANDS = [
  {
      ...
      npcs: [
        {
          ...
          lines: [
            { speaker: '세렌', sprite: 'seren', text: '여기가 시작의 섬이야. 공기에서 잉크 냄새가 나… 도안 조각이 가까워.' },
            { speaker: '세렌', sprite: 'seren', text: '무작정 쳐들어가는 건 초보 항해사나 하는 짓이야. 마을 사람들 얘기부터 들어보자.' },
            { speaker: '세렌', sprite: 'seren', text: '그리고 하나 더 — 배엔 이름표가 있어야지. 떠나기 전에 네 마크를 정하자.' },
    ...
    boss: {
      ...
      attackMin: 12,
      attackMax: 26,
      situation: '보스전(수풀의 파수꾼 가르) — 플레이어에게 무기를 그리라고 요청함',
