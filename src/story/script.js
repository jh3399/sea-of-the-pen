...
export const SCRIPT = {
  ...
  THE_SKETCHBOOK: [
    { speaker: '모루', sprite: 'moru', bg: 'workshop', text: '거기서 뭘 그렇게 오래 서 있는 것이냐.' },
    ...
    { speaker: '모루', sprite: 'moru', text: '들어와라. 문간에서 할 얘기가 아니야.' },
